    ...
    fields: [
      {
        ...
        options: [
          ...
          { value: 'LETTER_OF_SUPPORT', label: 'Letter of support', color: 'purple' },
      ...
      { name: 'dueDate', label: 'Due date', type: 'DATE_TIME', icon: 'IconCalendarDue' },
      { name: 'formNumber', label: 'Form number', type: 'TEXT', icon: 'IconHash' },
      { name: 'notes', label: 'Notes', type: 'TEXT', icon: 'IconNotes' },
    ],
    defaultColumns: ['application', 'category', 'status', 'dueDate', 'formNumber'],
  },
];
