...
const journalTemplateRecords = (): SeedRecord[] => [
  ...
  makeRecord('journalTemplate', 'acs', 5, {
    ...
    outputFormats: ['DOCX', 'PDF'],
    notes:
      'Chemistry journals; numeric superscript-style citations; combined Results and discussion.',
  }),
  ...
  makeRecord('journalTemplate', 'vancouver', 8, {
    name: 'Vancouver (numeric, biomedical)',
    citationMode: 'NUMERIC',
    ...
    referenceDocUrl: '',
    outputFormats: ['DOCX', 'PDF'],
    notes: 'ICMJE/Vancouver numeric — medicine, public & environmental health.',
  }),
  makeRecord('journalTemplate', 'thesis-generic', 9, {
  ...
  makeRecord('journalTemplate', 'air-quality-atmosphere-health', 10, {
    ...
    headingFontSize: 12,
    lineSpacing: 2,
    abstractLineSpacing: 2,
    bodyAlignment: 'JUSTIFIED',
    referenceDocUrl: '',
    outputFormats: ['DOCX', 'PDF', 'ZIP'],
    notes:
      'Springer author-date submission profile with editable source files.',
  }),
  makeRecord(
    'journalTemplate',
    ...
    11,
    {
      ...
      referenceDocUrl: '',
      outputFormats: ['DOCX', 'PDF', 'ZIP'],
      notes: 'Springer author-date profile with statements and declarations.',
    },
  ),
  makeRecord('journalTemplate', 'archives-environmental-contamination', 12, {
    ...
    referenceDocUrl: '',
    outputFormats: ['DOCX', 'PDF', 'ZIP'],
    notes: 'Springer author-date profile for original research submissions.',
  }),
  makeRecord('journalTemplate', 'atmospheric-environment', 13, {
    ...
    outputFormats: ['DOCX', 'PDF', 'ZIP'],
    notes:
      'Elsevier profile; highlights are 3–5 lines, each up to 85 characters.',
  }),
  makeRecord('journalTemplate', 'scientific-coauthor-review', 14, {
    name: 'Scientific co-author review (Times)',
    profileKey: 'scientific-coauthor-review-times',
    citationMode: 'AUTHOR_DATE',
    citationStyleId: 'apa',
    figureLabelFormat: 'Figure {n}',
    tableLabelFormat: 'Table {n}',
    ...
    crossRefFormat: 'Figure {n}',
    figureCaptionPosition: 'BELOW',
    figureCaptionFontSize: 10,
    figureCaptionLineSpacing: 1,
    figureCaptionGap: 3,
    figureCaptionSpacingAfter: 6,
    tableCaptionPosition: 'ABOVE',
    ...
    headingColor: 'BLACK',
    lineSpacing: 2,
    abstractLineSpacing: 1,
    paragraphSpacingAfter: 0,
    bodyAlignment: 'JUSTIFIED',
    affiliationAlignment: 'LEFT',
    affiliationNumberStyle: 'SUPERSCRIPT',
    affiliationLineSpacing: 1,
    affiliationSpacingAfter: 0,
    tableStyle: 'ACADEMIC',
    tableFontSize: 10,
    tableLineSpacing: 1,
    referenceDocUrl: '',
...
const obligationRecords = (): SeedRecord[] => [
  ...
  makeRecord('obligation', 'weekly-lab-slide', 4, {
    ...
    notes:
      'Marking this complete auto-creates the Week 16 deck, due a week later.',
  }),
];
